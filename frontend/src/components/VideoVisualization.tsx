        ...
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              {videoGenerations.some(shoe => shoe.videos.some(video => video.status === 'processing')) && (
                <div className="flex items-center gap-2 mt-2">
                  <div className="w-4 h-4 border-2 border-gray-200 border-t-purple-500 rounded-full animate-spin" />
                  <p className="text-sm text-purple-600 font-medium">Generating videos...</p>
                </div>
              )}
            </div>
          </div>
            ...
            >
              {currentVideo?.video_url && currentVideo.status === 'completed' ? (
                ...
                <div className="flex justify-center items-center h-80 bg-gray-100 rounded-lg">
                  <div className="text-center text-gray-500">
                    <Play className="w-12 h-12 mx-auto mb-2 opacity-50" />
                    <p>Video will appear here when ready</p>
                  </div>
                </div>
              )}
            </motion.div>
